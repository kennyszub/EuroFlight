...
- (void)animateTransition:(id<UIViewControllerContextTransitioning>)transitionContext {
    ...
    if (self.isPushTransition) { // is presenting
        ...
        toViewController.view.frame = CGRectMake(toViewController.view.bounds.size.width + 18, 0, toViewController.view.bounds.size.width, toViewController.view.bounds.size.height);
        ...
        [UIView animateWithDuration:TRANSITION_DURATION animations:^{
            ...
            fromViewController.view.frame = CGRectMake(-fromViewController.view.bounds.size.width - 18, 0, fromViewController.view.bounds.size.width, fromViewController.view.bounds.size.height);
